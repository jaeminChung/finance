# -*- coding: utf-8 -*-
"""
    playground.controller.scraping_daum_stock_bot
    ~~~~~~~~~~~~~~~~~~~~~~~~~
...
#            if not exist:
    ...
    if next_page > 0:
        save_stock_price(stock_code, next_page)    
    else:
        Log.info("끝!")
...
def show_stock_list():
    return dao.query(Stock).order_by(Stock.company_name.asc()).all()


stock_list =  show_stock_list
save_stock_price(stock_list[1])
